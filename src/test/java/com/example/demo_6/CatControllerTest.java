...
import com.example.demo_6.controller.CatController;
import com.example.demo_6.model.Cat;
import com.example.demo_6.service.CatService;
...
public class CatControllerTest {
    ...
    void save() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(status().isOk())
                .andExpect((ResultMatcher) content().json(userObject.toString()));
